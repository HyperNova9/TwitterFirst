...
<body class="bg-light">
	...
	<div class="main mt-3">
							...
							<div class="col-10">
								<form method="GET" action="insert.php">
									<div class="col-12">
										...
										<textarea name="twit" class="form-control" placeholder="Что нового?"></textarea>
									</div>
									<div class="col-12">
										<div class="row">
											<div class="col-8">
		...
		$text_query = "SELECT * FROM twits";//То что берёт от оттуда;

		 //В ставить в таблицы в колонках автор, твит, картинка чето чето....
 ...
 //запрос для ввода в таблицу
	...
	<?php
		...
		$text_query = "SELECT * FROM followings";//То что берёт от оттуда;
 ...
 //запрос для ввода в таблицу
		...
		$results2 = $query->fetch_assoc();
		$results3 = $query->fetch_assoc();
		$results4 = $query->fetch_assoc();
	?>
						<!-- пост 1-->
						<div class="row mt-4">
							<!-- account_image -->
				...
				<div class="col-sm-12 col-md-4 col-xl-3">
					...
					<div class="bg-white pt-3 pb-3 pl-3 pr-3">
						...
						<form action="insert2.php" method="GET">
							<p><input type="" name="names" placeholder = "Имя"></p>
							<p><input type="" name="logins" placeholder = "Логин"></p>
							<p><input type="" name="imgs" placeholder = "Изображение"></p>
							<button class="">Добавить в читаемые</button>
						</form>
						<div class="col-4">
							<h6>Читаемые</h6>
						</div>
						...
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" <?php echo "src='".$results["img"]."'";?>></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
									<a href=""><?php echo $results["name"];?></a>  <!-- имя юзера -->
									<span style="font-size: 12px;"><?php echo $results["login"];?></span> <!--название аккаунта-->
								</div>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" <?php echo "src='".$results2["img"]."'";?>></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
									<a href=""><?php echo $results2["name"];?></a>  <!-- имя юзера -->
									<span style="font-size: 12px;"><?php echo $results2["login"];?></span> <!--название аккаунта-->
								</div>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" <?php echo "src='".$results3["img"]."'";?>></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
									<a href=""><?php echo $results3["name"];?></a>  <!-- имя юзера -->
									<span style="font-size: 12px;"><?php echo $results3["login"];?></span> <!--название аккаунта-->
								</div>
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" <?php echo "src='".$results4["img"]."'";?>></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
									<a href=""><?php echo $results4["name"];?></a>  <!-- имя юзера -->
									<span style="font-size: 12px;"><?php echo $results4["login"];?></span> <!--название аккаунта-->
								</div>
							</div>
						</div>
